// MoathCo Adventure - Gear Items & Lore Books

StartupEvents.registry('item', event => {

    // === MoathCo Alloy Ingot ===
    event.create('moathco_alloy')
        .displayName('§6MoathCo Alloy')
        .tooltip('§7A refined alloy unique to MoathCo Industrial.')
        .tooltip('§8Used to craft MoathCo-grade equipment.');

    // === MoathCo Field Blade ===
    event.create('moathco_field_blade', 'sword')
        .tier('iron')
        .displayName('§6MoathCo Field Blade')
        .glow(true)
        .tooltip('§6§lMoathCo Industrial Equipment')
    ...
    event.create('moathco_files_vol_1')
        .displayName('§6MoathCo Files: Vol. I')
        .glow(true)
        ...
        .tooltip('§8§o— MoathCo Research Division');

    event.create('moathco_files_vol_2')
        .displayName('§cMoathCo Files: Vol. II')
        .glow(true)
    ...
    event.create('moathco_files_vol_3')
        .displayName('§bMoathCo Files: Vol. III')
        .glow(true)
    ...
    event.create('moathco_files_vol_4')
        .displayName('§eMoathCo Files: Vol. IV')
        .glow(true)
    ...
    event.create('moathco_files_vol_5')
        .displayName('§dMoathCo Files: Vol. V')
        .glow(true)
